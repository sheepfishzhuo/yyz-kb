import{_ as a,c as n,o as s,a5 as p}from"./chunks/framework.DLTOeEcZ.js";const m=JSON.parse('{"title":"Open3D 点云的圆柱形邻域搜索","description":"","frontmatter":{},"headers":[],"relativePath":"point-cloud/点云侠/Open3D 点云的圆柱形邻域搜索.md","filePath":"point-cloud/点云侠/Open3D 点云的圆柱形邻域搜索.md"}'),e={name:"point-cloud/点云侠/Open3D 点云的圆柱形邻域搜索.md"},t=p(`<h1 id="open3d-点云的圆柱形邻域搜索" tabindex="-1">Open3D 点云的圆柱形邻域搜索 <a class="header-anchor" href="#open3d-点云的圆柱形邻域搜索" aria-label="Permalink to &quot;Open3D 点云的圆柱形邻域搜索&quot;">​</a></h1><h2 id="一、算法原理" tabindex="-1">一、算法原理 <a class="header-anchor" href="#一、算法原理" aria-label="Permalink to &quot;一、算法原理&quot;">​</a></h2><p>代码中实现过程已十分清晰明了，无需做过多介绍。</p><h2 id="二、代码实现" tabindex="-1">二、代码实现 <a class="header-anchor" href="#二、代码实现" aria-label="Permalink to &quot;二、代码实现&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>import open3d as o3d</span></span>
